...
#define PM_INFO_MX7ULP_TTBR0_V_OFF		0x70
#define PM_INFO_MX7ULP_TTBR1_V_OFF		0x74
#define PM_INFO_MX7ULP_GPIO_REG_OFF		0x78
#define PM_INFO_MX7ULP_IOMUX_NUM_OFF		0x98
#define PM_INFO_MX7ULP_IOMUX_VAL_OFF		0x9c
#define PM_INFO_MX7ULP_SELECT_INPUT_NUM_OFF	0x26c
#define PM_INFO_MX7ULP_SELECT_INPUT_VAL_OFF	0x270
#define PM_INFO_MX7ULP_MMDC_IO_NUM_OFF		0x3a8
#define PM_INFO_MX7ULP_MMDC_IO_VAL_OFF		0x3ac
/* below offsets depends on MX7ULP_MAX_MMDC_IO_NUM(36) definition */
#define PM_INFO_MX7ULP_MMDC_NUM_OFF		0x4cc
#define PM_INFO_MX7ULP_MMDC_VAL_OFF		0x4d0
